...
path = 'E://профиль//PycharmProjects//learn_project//'
...
# t = ''
#
# lbl = Label(master=wnd, text='What''s yor name?')
# lbl.configure(font=fnt_1)
# lbl.place(x = 10, y = 20)

# btnOK = Button(wnd, text='Ok', command=clicked)
# btnOK.configure(font=fnt_3)
# btnOK.place(x=40, y=80, width=100, height=30)

btn2 = Button(wnd, text='Cancel', command=wnd.destroy)
btn2.configure(font=fnt_3)
btn2.place(x=60, y=260, width=100, height=30)

# txt = Entry(wnd, width=20)
